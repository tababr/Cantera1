SubProceso areaRectangulo(base0, altura)
...
SubProceso areaTriangulo(base0, altura)
	Definir area Como Real;
	area <- (base0*altura)/2;
	Escribir '';
...
SubProceso areaTrapecio(base0, base1, altura)
	Definir area Como Real;
	...
	Repetir
		...
		Segun opcion Hacer
			...
			3:
				...
				Escribir Sin Saltar 'Ingrese la altura';
				Leer altura;
				areaTrapecio(base0, base1, altura);
			4:	
